...
public class PollsCreation 
{
	...
	String url ="https://polls-766644477.development.catalystserverless.com/app/";
	    ...
	    System.out.println("Launching..");
            ...
            frame.type("input[name='username']", "YOUR USERNAME");
		  ...
		  System.out.println("Start to create poll");
            ...
            page.type("input[name='QuestionContent']","Which is your favourite programming language");
            ...
            page.waitForNavigation(()->{
                page.waitForSelector("button[type='submit']").click();
            });
            
            //Check whether polls successfully created or not
            Locator check = page.locator("text = created");
            if(check.count()>0) {
                System.out.println("Your poll has been successfully created");
            }
            else {
                System.out.print("Failed to create your poll");
            }
	    page.close();
